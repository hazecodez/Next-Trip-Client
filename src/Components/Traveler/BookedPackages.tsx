            ...
            <div className="group select-none w-[250px] flex flex-col p-4 relative items-center justify-center bg-gray-800 border border-gray-800 shadow-lg rounded-2xl">
              <div className="">
                ...
                <div className="p-2 mt-2 text-center space-x-1 md:block">
                  ...
                  <button
                    onClick={() => handleCancellation(bookId)}
            ...
            >
              <div>
                ...
                <ul className="steps">
                  ...
                  <li
                    data-content={`${
                      !isDateInThePast(data.startDate as string)
                        ? "✓"
                        : "2"
                    }`}
                    className={`step ${
                  ...
                  <li data-content={`${
                    ...
                    className={`step ${
                      !isDateInThePast(data.endDate as string)
                        ? "step-success"
                        : ""
                    } `}>
                    Travel Finished
                ...
                {isDateInThePast(data.cancelDate as string) && (
                  <p className="text-red-600 font-bold pt-5">
                    Cancellation last date{" "}
                    {formatDate(data.cancelDate as string)}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {isDateInThePast(data.cancelDate as string) && (
                  <button
                    onClick={() => {
                      setConfirmModal(true), setBookid(data?._id as string);
                    }}
