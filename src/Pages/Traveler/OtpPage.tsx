              ...
              <form action="" method="post">
                <div className="flex flex-col space-y-16">
                  ...
                  <div className="flex flex-col space-y-5">
                    <div>
                      <button className="flex flex-row items-center justify-center text-center w-full border rounded-xl outline-none py-5 dark:bg-gray-800 border-none text-white text-sm shadow-sm">
                        Verify Account
                      </button>
                    </div>
